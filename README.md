...
- [@Steve5wutongyu6](https://github.com/Steve5wutongyu6) — macOS Agent 托盘/设置窗崩溃修复方案（PR #35）
- [@nmb1337](https://github.com/nmb1337) — Android 保活看门狗思路（PR #37）、「测试连接」交互、CI 自动构建 APK 的做法
- [@qwe5283](https://github.com/qwe5283) — 健康数据两个关键 bug 的发现与修复思路
- [@luckylaiCN](https://github.com/luckylaiCN) — Agent 打包路径兼容修复，以及本分支 #31 的三个显示问题反馈
